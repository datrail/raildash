...
test: $(VENV)
	...
	$(PY) -m pytest -q --ignore=tests/test_browser.py --ignore=tests/test_browser_asp_write_routes.py
...
browser-test: $(VENV)
	$(PY) -m pytest -q tests/test_browser.py tests/test_browser_asp_write_routes.py
